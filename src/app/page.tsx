      ...
      <ReactLenis root>
        ...
        <div id="features" data-section="features">
          <FeatureBento
            ...
            features={[
              {
                title: "General Dentistry",                description: "Preventive care, cleanings, and checkups to maintain your oral health.",                bentoComponent: "reveal-icon",                icon: CheckCircle,
                imageSrc: "http://img.b2bpic.net/free-vector/dental-design-concept_1284-4395.jpg",                imageAlt: "glowing tooth icon dental"
              },
              {
                title: "Implants & Prosthetics",                description: "Comfortable, high-quality tooth replacements designed to feel natural.",                bentoComponent: "reveal-icon",                icon: Sparkles,
                imageSrc: "http://img.b2bpic.net/free-photo/beauty-salon-treatment-room_181624-30807.jpg",                imageAlt: "glowing tooth icon dental"
              },
              {
                title: "Endodontics",                description: "Expert treatment for deep infections and root canal care.",                bentoComponent: "reveal-icon",                icon: Shield,
